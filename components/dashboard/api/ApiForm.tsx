...
const ApiForm = () => {
  ...
  return (
    <div className="w-full space-y-6">
      {/* notes */}
      <div>
        <label className="block mb-1 text-[12px] font-light">
          {t("notes")}
        </label>
        <input
          type="text"
      ...
      <div className="w-full space-y-3">
        ...
        <div className="flex justify-between gap-2 flex-wrap">
          ...
          <div className="flex gap-1 items-center">
            ...
            <label className="text-[10px] font-light">{t("accBalance")}</label>
          </div>
          {/* add order */}
          <div className="flex gap-1 items-center">
            <input type="checkbox" className="" />
            <label className="text-[10px] font-light">{t("addOrder")}</label>
          </div>
          {/* get order */}
          <div className="flex gap-1 items-center">
            <input type="checkbox" className="" />
            <label className="text-[10px] font-light">{t("getOrder")}</label>
          </div>
          {/* close order */}
          <div className="flex gap-1 items-center">
            <input type="checkbox" className="" />
            <label className="text-[10px] font-light">{t("closeOrder")}</label>
          </div>
        </div>
      </div>
      ...
      <div className="w-full space-y-3">
        ...
        <div className="">
          ...
          ></textarea>
          <p className="text-slate-500 text-[12px]">{t("expDate")}</p>
        </div>
      </div>
