...
const Profile = () => {
  ...
  const nameChangeHandler = (data: string) => {
    ...
    setIsSuccessMessage("Nickname Successfully Changed");
    setTimeout(() => {
      setIsSuccessMessage("");
    }, 2000);
  };
  ...
  const pictureChangeHandler = (data: string) => {
    ...
    setIsSuccessMessage("Profile Picture Successfully Changed");
    setTimeout(() => {
      setIsSuccessMessage("");
    }, 2000);
  };
  ...
  return (
    <div className="bg-white dark:bg-[#161735] p-8 rounded-lg  mx-auto relative">
      ...
      <h2 className={`${saira.className} text-sm font-semibold `}>Profile</h2>
      <div className="flex flex-col gap-6 mt-4">
        ...
        <div className="flex justify-between items-center  text-xs ">
          <div className="flex items-center gap-2  ">
            ...
            <div>
              <div className="font-xs font-light opacity-90">Nickname</div>
              <div className="text-[11px] font-light opacity-60">
                This is your display name that will appear to others on the
                platform
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center  text-xs ">
          <div className="flex items-center gap-2  ">
            ...
            <div>
              <div className="font-xs font-light opacity-90">Photo</div>
              <div className="text-[11px] font-light opacity-60">
