        ...
        <div className=' flex flex-col lg:flex-row gap-6 items-center justify-center w-full'>
                ...
                <div className='  border-2 border-[#eff0f2] dark:border-[#161735] bg-transparent rounded-full w-full h-full flex justify-center items-center'>
                    <div className='w-[90%] h-[90%] bg-[#eff0f2] dark:bg-[#161735] rounded-full flex justify-center items-center '>
                        <div className='w-[80%] h-[80%] bg-green-400 dark:bg-green-600 animate-pulse duration-1000 rounded-full'>
                            <Image width={1000} height={1000} src="/images/computermobile.png" alt="" className='w-[500px] pl-2 h-auto absolute top-1/2 right-1/2 -translate-y-1/2 translate-x-1/2 invert dark:invert-0' />
                        </div>
                    </div>
                </div>
                </div>
            ...
            <div className='w-full  flex flex-col items-center  gap-4  '>
                <div className='w-fit  lg:w-full flex flex-col'>
                    <h3 className={` ${saira.className} text-wrap text-center lg:text-start lg:text-nowrap text-[24px] font-medium`}>Trade seamlessly across devices</h3>
                    <p className=' text-wrap text-center lg:text-start lg:text-nowrap text-[12px] font-extralight'>Download our mobile app for effortless crypto trading!</p>
                </div>
                <div className='w-fit lg:w-full h-full  flex gap-2  '>
                    {/* qr code */}
                    <div className='   flex items-center justify-center '>
                          <Card>
                       <Image width={100} height={100} src="/images/testqr.png" alt="" className='w-20 h-20 rounded-md invert dark:invert-0'/>
                    </Card>
                    </div>
                    ...
                    <div className='h-full flex flex-col justify-between gap-2 '>
                        ...
                        <div className='w-full h-full flex items-center text-center rounded-md p-2 px-3 bg-[#eff0f2] dark:bg-[#161735]'> 
                        ...
                        <div className='w-full h-full flex items-center text-center'> 
                           ...
                           <div className='w-full h-full flex items-center text-center gap-2 rounded-md p-2 px-3 bg-[#eff0f2] dark:bg-[#161735]'> 
                                {/* logo */}
