    ...
    >
        ...
        {/* image*/}
            ...
            { activeState == 1 && <Image width={100} height={100} src={`/images/computerSignUp.png`} className='w-[250px] ml-4' alt="" />}
             ...
             { activeState == 2 && <Image width={100} height={100} src={`/images/computermobile.png`} className='w-[250px] ml-4' alt="" />}
        ...
        {activeState==1 && <div className='flex flex-col sm:justify-start  items-center sm:items-start text-center sm:text-start  w-fit'>
            ...
            {/* button */}
            <button className='w-fit flex mt-4 text-[14px] font-medium items-center gap-1 px-3 py-1 rounded-full bg-green-700 text-black cursor-pointer '>
                Get Started 
        ...
        {activeState==2 && <div className='flex flex-col sm:justify-start  items-center sm:items-start text-center sm:text-start  w-fit'>
            ...
            <p className='max-w-[320px] text-[12px] font-extralight '>Sign up in minutes with your email, set a secure password, and verify your identity for a safe trading experience.</p>
            {/* button */}
            <button className='w-fit flex mt-4 text-[14px] font-medium items-center gap-1 px-3 py-1 rounded-full bg-cyan-700 text-white cursor-pointer '>
                Update KYC 
                <IoIosArrowRoundForward className='text-lg'/>
            </button>
        </div>}

        {activeState >=3 && <div className='flex flex-col sm:justify-start  items-center sm:items-start text-center sm:text-start  w-fit'>
            {/* title */}
            <h3 className='font-bold'>Start Trading</h3>
            {/* sub title */}
            <p className='max-w-[320px] text-[12px] font-extralight '>Sign up in minutes with your email, set a secure password, and verify your identity for a safe trading experience.</p>
            {/* button */}
            <button className='w-fit flex mt-4 text-[14px] font-medium items-center gap-1 px-3 py-1 rounded-full bg-yellow-700 text-white cursor-pointer '>
                 Start Trading
                <IoIosArrowRoundForward className='text-lg'/>
            </button>
        </div> }
