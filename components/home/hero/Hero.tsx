...
const Hero = () => {
  return (
    <div className="w-full h-screen flex justify-center items-center text-white relative  ">
      {/* background */}

      {/* /heading and subheading */}
      <div className="w-full absolute z-[50] top-24 right-0 text-center ">
      ...
      <div className='w-full h-full absolute top-0 right-0 bg-[#06062a] opacity-80 blur-3xls z-[30]'></div>

      <div className="absolute bottom-0 right-0 w-full py-2 z-[40] bg-green-700 flex justify-center">
        <Marquee>
           <HeroCurrencyStrip />
        </Marquee>
      </div>
