    ...
    <div className="w-full  h-fit   ">
      <div className="w-[65%] sm:w-[75%]  relative rounded-r-md py-8 flex justify-end  ">
        ...
        <div
          ...
          }  transition-all duration-500 p-4 py-6 rounded-l-md flex flex-col gap-10`}
        >
          ...
          <div
            className={` ${
              isUserBenefits
                ...
                : "left-1/2 translate-y-[40px]"
            } absolute  text-slate-500 pl-[50%] text-[12px] sm:text-[14px] z-[20] text-nowrap font-medium cursor-pointer  transition-all duration-500 hover:scale-105 hover:text-slate-300`}
            onClick={() => {
