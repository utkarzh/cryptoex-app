...
const MediaKit = () => {
  ...
  return (
    <div className="w-full my-10 flex flex-col gap-8">
      {/*heading  */}
      <div>
        <h2 className={`${saira.className} text-xl font-medium`}>
          {t("title")}
        </h2>
        <p className="text-[10px] font-light mt-1">{t("content")}</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="w-full flex justify-between">
          <h4 className="text-sm font-medium">{t("terms.downloadHeading")}</h4>
          {/* button */}
      ...
      <div className="flex h-full flex-col gap-6">
        <h4 className="text-sm font-medium">{t("terms.brandAssets")}</h4>
        {/* logos */}
        <div className="rounded-md p-4 bg-white dark:bg-[#161735] h-full flex gap-2 items-center ">
          ...
          <div className="w-full flex flex-col gap-1 border-l-2 border-slate-500/20 pl-6 ml-6">
            <h3 className="text-sm font-normal">{t("terms.logos")}</h3>
        ...
        <div className="rounded-md p-4 bg-white dark:bg-[#161735] h-full flex gap-2 items-center ">
          <div className="flex flex-col gap-1 max-w-[100px]">
            <p className="text-sm font-bold">{t("terms.sairaBold")}</p>
            <p className="text-sm font-normal">{t("terms.inter")}</p>
          </div>

          <div className="w-full flex flex-col gap-1 border-l-2 border-slate-500/20 pl-6 ml-6">
            <h3 className="text-sm font-normal">{t("terms.typeFace")}</h3>
            <p className="text-[10px] fonr-light opacity-80 ">
        ...
        <div className="rounded-md p-4 bg-white dark:bg-[#161735] h-full flex gap-2 items-center ">
          ...
          <div className="w-full flex flex-col gap-1 border-l-2 border-slate-500/20 pl-6 ml-6">
            <h3 className="text-sm font-normal">{t("terms.colors")}</h3>
            <p className="text-[10px] fonr-light opacity-80 ">
